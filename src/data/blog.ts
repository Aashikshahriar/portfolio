...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      "This is the first post on my personal blog. I plan to use this space to write short notes on papers I'm reading, experiments I'm running, and lessons learned while working across domain of my interests.",
      "Expect a mix of technical deep-dives (e.g. on domain adaptation, privacy-preserving ML, or EEG-fMRI artifact removal) and occasional posts on conferences, travel, and life outside the research.",
  ...
  },
  {
    ...
    content: [
      ...
      "All the codes as I work through so far, are in a public github repo. It's built to be a set of self-contained, closed-form replications rather than a polished library, so each folder should run on its own.",
    ],
    resources: [
